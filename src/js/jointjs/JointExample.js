;define([  'jointjs/JointNetworkAdapter', 'jointjs/Shapes' ], function(    JointNetworkAdapter, Shapes){
  console.log("File loaded:JointSampleGraph"); 
  ...
  return function(){   
      ...
      console.log("sample graph", graph)
      c1.embed(a1);
